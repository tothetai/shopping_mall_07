jQuery(document).ready(function() {
    ...
    jQuery(".content3-slide").owlCarousel( {
        loop:true,
        margin:30,
        autoplay:true,
        dots:false,
...
new Marquee("scro",0,1,270,90,30,0,500)

$("#dm-l > ul > li").click(function() {
    if($(this).hasClass("active4")) {
        ...
        $(".s-1").slideUp(500);
        $("#dm-l > ul > li").removeClass("active4");
        $(this).addClass("active4");
        $(this).children(".s-1").slideDown();
    }
});
